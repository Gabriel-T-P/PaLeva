...
describe 'usuário abre página de configurações' do
  it 'pela sidebar no nome do usuário' do
    ...
    establishment = Establishment.create!(corporate_name: 'Carlos LTDA', trade_name: "Carlo's Café", full_address: 'Rio Branco, Deodoro', admin_user: user, cnpj: CNPJ.generate, 
