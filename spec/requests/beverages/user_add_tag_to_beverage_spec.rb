...
describe 'usuário adiciona marcador a bebida' do
  it 'mas não pertence àquele estabelecimento' do
    ...
    login_as user2
    post add_tag_establishment_beverage_path(establishment1, beverage), params: {
      tag: {
        name: 'Refrescante',
  ...
  it 'e não está logado' do
    ...
    post add_tag_establishment_beverage_path(establishment, beverage), params: {
      tag: {
        name: 'Refrescante',
        description: 'muito refrescante'
      }
