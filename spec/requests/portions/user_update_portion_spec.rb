...
describe 'usuário atualiza uma porção' do
  context 'pelas bebidas' do
    it 'mas não pertence àquele estabelecimento' do
      ...
      login_as user2
      put establishment_beverage_portion_path(establishment1, beverage, portion), params: {
        beverage: {
          name: 'Água',
          price: 8.0
        }
    ...
    it 'e não está logado' do
      ...
      put establishment_beverage_portion_path(establishment, beverage, portion), params: {
        beverage: {
          name: 'Água',
          price: 8.0
        }
  ...
  context 'pelos pratos' do
    it 'mas não pertence àquele estabelecimento' do
      ...
      login_as user2
      put establishment_item_portion_path(establishment1, dish, portion), params: {
        item: {
          name: 'Água',
          price: 8.0
        }
    ...
    it 'e não está logado' do
      ...
      put establishment_item_portion_path(establishment, dish, portion), params: {
        item: {
          name: 'Água',
          price: 8.0
        }
