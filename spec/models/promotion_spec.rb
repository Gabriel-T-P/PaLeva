...
RSpec.describe Promotion, type: :model do
  describe '#convert_percentage' do
    it 'porcentagem não estiver presente' do
      ...
      expect(promotion.percentage).to eq nil
    end

    it 'quando porcentagem é inteiro' do
      establishment = Establishment.create!(corporate_name: 'Carlos LTDA', trade_name: "Carlo's Café", full_address: "Rio Branco, Deodoro", 
                                              cnpj: '42.182.510/0001-77', email: 'carlosjonas@email.com', phone_number: '99999043113')
      dish = Item.create!(name: 'Lasanha', description: 'Carne, macarrão e molho', calories: '340', item_type: 'dish', establishment: establishment)
      portion = Portion.create!(name: 'Meia Lasanha', description: 'Lasanha de carne para 1 pessoa', price: 7.50, item: dish)
      promotion = Promotion.new(name: 'Teste01', percentage: 20, use_limit: 20, start_date: Date.current, end_date: 1.day.from_now.to_date, portions: [portion])

      promotion.valid?

      expect(promotion.percentage).to eq 0.2
    end
    
    it 'quando porcentagem é quebrado' do
      establishment = Establishment.create!(corporate_name: 'Carlos LTDA', trade_name: "Carlo's Café", full_address: "Rio Branco, Deodoro", 
                                              cnpj: '42.182.510/0001-77', email: 'carlosjonas@email.com', phone_number: '99999043113')
      dish = Item.create!(name: 'Lasanha', description: 'Carne, macarrão e molho', calories: '340', item_type: 'dish', establishment: establishment)
      portion = Portion.create!(name: 'Meia Lasanha', description: 'Lasanha de carne para 1 pessoa', price: 7.50, item: dish)
      promotion = Promotion.new(name: 'Teste01', percentage: 20.50, use_limit: 20, start_date: Date.current, end_date: 1.day.from_now.to_date, portions: [portion])

      promotion.valid?

      expect(promotion.percentage).to eq 0.205
    end

    it 'porcentagem já está normalizado' do
      establishment = Establishment.create!(corporate_name: 'Carlos LTDA', trade_name: "Carlo's Café", full_address: "Rio Branco, Deodoro", 
                                              cnpj: '42.182.510/0001-77', email: 'carlosjonas@email.com', phone_number: '99999043113')
      dish = Item.create!(name: 'Lasanha', description: 'Carne, macarrão e molho', calories: '340', item_type: 'dish', establishment: establishment)
      portion = Portion.create!(name: 'Meia Lasanha', description: 'Lasanha de carne para 1 pessoa', price: 7.50, item: dish)
      promotion = Promotion.new(name: 'Teste01', percentage: 0.50, use_limit: 20, start_date: Date.current, end_date: 1.day.from_now.to_date, portions: [portion])

      promotion.valid?

      expect(promotion.percentage).to eq 0.50
    end
  end
  ...
  describe '#valid?' do
    context 'quando Nome' do
      it 'estiver ausente' do
        ...
        dish = Item.create!(name: 'Lasanha', description: 'Carne, macarrão e molho', calories: '340', item_type: 'dish', establishment: establishment)
        portion = Portion.create!(name: 'Meia Lasanha', description: 'Lasanha de carne para 1 pessoa', price: 7.50, item: dish)
        promotion = Promotion.new(name: '', percentage: 75, use_limit: 20, start_date: Date.current, end_date: 1.day.from_now.to_date, portions: [portion])
